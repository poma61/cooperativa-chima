                        ...
                        <table id="tabla-datos" class="color-table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('route-frm-show-registro-comisiones-informes',Crypt::encrypt($row->id))}}"
                                            class="edit-reg"><i class="zmdi zmdi-edit"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{route('route-pdf-id-registro-comisiones-informes',Crypt::encrypt($row->id))}}"
