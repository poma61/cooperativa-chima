...
<body>
    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                ...
                <div class="title-info">Registrar Actas Tribunal De Honor</div>

                <div class="container-menu-opciones-all">
                    <!-- menu opciones-->
                    <x-menu_opciones.MenuOpRegistroAcTribunalDeHonor />
                </div>


                <!-- formulario-->
                <div class="container-form">
                    <h3 class="title-form-control">Tribunal de Honor</h3>
                    ...
                    <form class="mi-form-control" id="mi-form" enctype="multipart/form-data">
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="text" name="referencia" value="{{$registro_ac_tribunal_de_honor->referencia}}"
                                maxlength="580">
                        ...
                        <div class="campo-form-control-area">
                            ...
                            <textarea name="descripcion">{{$registro_ac_tribunal_de_honor->descripcion}}</textarea>
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="text" name="institucion"
                                value="{{$registro_ac_tribunal_de_honor->institucion}}" maxlength="580">
                            <p class="advertencia-error" id="error-institucion"></p>
                        </div>

                        <div class="campo-form-control-area">
                            <label for="">Observacion<span class="asterisco-label">*</span></label>
                            <textarea name="observacion">{{$registro_ac_tribunal_de_honor->observacion}}</textarea>
                        ...
                        <div class="image-pre-view">
                            @if($registro_ac_tribunal_de_honor->archivo==null)
                            <img src="{{asset('assets/images/image-preview.png')}}" alt="Archivo Subido"
                                id="vista-previa">
                            @else
                            <img src="data:image/all;base64,{{base64_encode($registro_ac_tribunal_de_honor->archivo)}}"
    ...
    <script src="{{asset('assets/js/app/RegistroAcTribunalDeHonor.js')}}?v={{config('constants.VERSION_JS')}}"></script>
