...
<head>
    ...
    <link rel="stylesheet" href="{{public_path('assets/css/pdf-historial-personal-planta.css')}}" type="text/css" media="all">
        ...
        <div class="container-table-informacion">
            <table class="table-informacion">
                <tbody>
                    <tr>
                        <td colspan="3">
                            <h4>REGISTRO N° {{$personal_ep->num_empleado}}</h4>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td  colspan="2">
                            {{$personal_ep->nombres.' '.$personal_ep->apellidos}}
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            {{date_format(date_create($personal_ep->fecha_de_ingreso),'d/m/Y')}}
                        </td>
