    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                ...
                <div class="title-info">Registrar Personal de Planta</div>
                <!-- formulario-->
                <div class="container-form">
                    <h3 class="title-form-control">Formulario | Personal de Planta</h3>
                    <p>Los campos marcados con (*) son obligatorios</p>

                    <form action="" class="mi-form-control" id="mi-form">

                        @if($personal_ep->id!=0)
                        <input type="hidden" value="{{MyEncryption::encrypt($personal_ep->id)}}" name="id-reg">
                        @endif
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="number" name="n-empleado" value="{{str_pad($num_registro,5,'0',STR_PAD_LEFT)}}"
                                disabled>
                            @else
                            <input type="number" name="n-empleado" value="{{$personal_ep->num_empleado}}" disabled>
                            @endif
                        </div>

                        <div class="campo-form-control">
                            <label for="">Estado del Empleado<span class="asterisco-label">*</span></label>
                            <input type="text" name="estado_del_empleado" value="{{$personal_ep->estado_del_empleado}}">
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                <input type="text" name="nombres" maxlength="150" value="{{$personal_ep->nombres}}">
                                <p class="advertencia-error" id="error-nombres"></p>
                            </div>
                            <div class="campo-form-control-2">
                                <label for="">Apellidos<span class="asterisco-label">*</span></label>
                                <input type="text" name="apellidos" maxlength="150" value="{{$personal_ep->apellidos}}">
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                <input type="text" name="ci" maxlength="150" value="{{$personal_ep->ci}}">
                                <p class="advertencia-error" id="error-ci"></p>
                            </div>
                            <div class="campo-form-control-2">
                                <label for="">Carnet Valido Hasta<span class="asterisco-label">*</span></label>
                                <input type="date" name="ci_valido" value="{{$personal_ep->ci_valido}}">
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="date" name="fecha_de_nacimiento" value="{{$personal_ep->fecha_de_nacimiento}}">
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="text" name="lugar_de_nacimiento" maxlength="150"
                                value="{{$personal_ep->lugar_de_nacimiento}}">
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                <input type="text" name="profesion_ocupacion" maxlength="150"
                                    value="{{$personal_ep->profesion_ocupacion}}">
                            ...
                            <div class="campo-form-control-2">
                                ...
                                <input type="text" name="estado_civil" maxlength="100"
                                    value="{{$personal_ep->estado_civil}}">
                        ...
                        <div class="campo-form-control">
                            ...
                            <select name="sexo" id="">
                                ...
                                <option value="Hombre" @if($personal_ep->sexo=="Hombre") selected @endif >Hombre
                                </option>
                                <option value="Mujer" @if($personal_ep->sexo=="Mujer") selected @endif >Mujer</option>
                            </select>
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                <input type="text" name="licencia_de_conducir"
                                    value="{{$personal_ep->licencia_de_conducir}}">
                            ...
                            <div class="campo-form-control-2">
                                ...
                                <input type="date" name="licencia_de_conducir_valido"
                                    value="{{$personal_ep->licencia_de_conducir_valido}}">
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="number" name="celular" min="1" value="{{$personal_ep->celular}}">
                        ...
                        <div class="campo-form-control">
                            ...
                            <select name="lugar_de_trabajo" id="">
                                <option value="">--Seleccionar--</option>
                                <option value="Taller Cerro" @if($personal_ep->lugar_de_trabajo=="Taller Cerro")
                                    selected @endif >Taller Cerro</option>

                                <option value="Taller" @if($personal_ep->lugar_de_trabajo=="Taller") selected @endif
                                    >Taller</option>

                                <option value="Pukaloma" @if($personal_ep->lugar_de_trabajo=="Pukaloma") selected @endif
                                    >Pukaloma</option>

                                <option value="Pukaloma oficina" @if($personal_ep->lugar_de_trabajo=="Pukaloma oficina")
                                    selected @endif >Pukaloma oficina</option>

                                <option value="Oficina" @if($personal_ep->lugar_de_trabajo=="Oficina") selected @endif
                                    >Oficina</option>

                                <option value="Administracion" @if($personal_ep->lugar_de_trabajo=="Administracion")
                                    selected @endif
                                    >Administracion</option>

                                <option value="Sin especificar" @if($personal_ep->lugar_de_trabajo=="Sin especificar")
                                    selected @endif >Sin especificar</option>

                                <option value="Ninguno" @if($personal_ep->lugar_de_trabajo=="Ninguno") selected @endif
                                    >Ninguno</option>

                                <option value="Otros" @if($personal_ep->lugar_de_trabajo=="Otros") selected @endif
                                    >Otros</option>
                                @php
                                $txt_long="Sin lugar de trabajo";
                                @endphp
                                <option value="Sin lugar de trabajo" @if($personal_ep->lugar_de_trabajo==$txt_long)
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                <input type="date" name="fecha_de_ingreso" value="{{$personal_ep->fecha_de_ingreso}}">
                            ...
                            <div class="campo-form-control-2">
                                ...
                                <input type="text" name="cargo_a_desarrollar" maxlength="250"
                                    value="{{$personal_ep->cargo_a_desarrollar}}">
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                <label for="">Sueldo Asignado<span class="asterisco-label">*</span></label>
                                <input type="number" name="sueldo_asignado" value="{{$personal_ep->sueldo_asignado}}">
                                <p class="advertencia-error" id="error-sueldo_asignado"></p>
                            </div>

                            <div class="campo-form-control-2">
                                <label for="">Divisa<span class="asterisco-label">*</span></label>
                                <input type="text" name="divisa" maxlength="100" value="{{$personal_ep->divisa}}">
                        ...
                        <div class="campo-form-control">
                            ...
                            <select name="estado_de_retiro" id="">
                                <option value="">--Seleccionar--</option>
                                <option value="Renuncia voluntaria" @if($personal_ep->estado_de_retiro=="Renuncia
                                    voluntaria") selected @endif >Renuncia voluntaria</option>

                                <option value="Abandono" @if($personal_ep->estado_de_retiro=="Abandono") selected @endif
                                    >Abandono</option>

                                <option value="Despido" @if($personal_ep->estado_de_retiro=="Despido") selected @endif
                                    >Despido</option>

                                <option value="Otro motivo" @if($personal_ep->estado_de_retiro=="Otro motivo") selected
                                    @endif >Otro motivo</option>

                                <option value="Ninguno" @if($personal_ep->estado_de_retiro=="Ninguno") selected @endif
                                    >Ninguno</option>

                                <option value="Otros" @if($personal_ep->estado_de_retiro=="Otros") selected @endif
                                    >Otros</option>

                                <option value="Sin especificar" @if($personal_ep->estado_de_retiro=="Sin especificar")
                                    selected @endif >Sin especificar</option>
                                @php
                                $txt_long="Sin estado de retiro";
                                @endphp
                                <option value="Sin estado de retiro" @if($personal_ep->estado_de_retiro==$txt_long)
                        ...
                        <div class="campo-form-control-area">
                            ...
                            <textarea name="observacion">{{$personal_ep->observacion}}</textarea>
                        ...
                        <div class="image-pre-view">
                            @if($personal_ep->imagen==null)
                            <img src="{{asset('assets/images/image-preview.png')}}" alt="imagen socio"
                                id="vista-previa">
                            @else
                            <img src="data:image/all;base64,{{base64_encode($personal_ep->imagen)}}" alt="imagen socio"
                                id="vista-previa">
                            @endif
                        </div>
