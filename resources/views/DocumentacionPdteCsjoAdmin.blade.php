    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                ...
                <div class="title-info-color-1">Listado de Registros | Inventario de Documentacion Pdte. Csjo.
                    Administracion</div>

                <section class="container-menu-opciones">
                    <ul class="list-menu-opciones">
                        <li class="item-menu-opciones color-item-menu-opciones">
                            <a href="{{route('route-pdf-all-documentacion-pdte-csjo-admin')}}"><i
                                    class="zmdi zmdi-download"></i> PDF</a>
                        </li>
                        <li class="item-menu-opciones color-item-menu-opciones">
                            <a href="{{route('route-imprimir-all-documentacion-pdte-csjo-admin')}}"><i
                        ...
                        <table id="tabla-datos" class="color-table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('route-frm-show-documentacion-pdte-csjo-admin',MyEncryption::encrypt($row->id))}}"
                                            class="edit-reg"><i class="zmdi zmdi-edit"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{route('route-pdf-id-documentacion-pdte-csjo-admin',MyEncryption::encrypt($row->id))}}"
