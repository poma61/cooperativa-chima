...
<body>
    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                ...
                <div class="title-info">Registrar Asamblea Ordinaria</div>

                <div class="container-menu-opciones-all">
                    <!-- menu opciones de forma vertical -->
                    <x-menu_opciones.MenuOptionVerticalRegisAcAsOr />
                </div>

                <!-- formulario-->
                <div class="container-form">
                    <h3 class="title-form-control">Asamblea Ordinaria</h3>
                    ...
                    <form class="mi-form-control" id="mi-form" enctype="multipart/form-data">
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="text" name="referencia" value="{{$registro_ac_as_ordinarias->referencia}}"
                                maxlength="580">
                        ...
                        <div class="campo-form-control-area">
                            ...
                            <textarea name="descripcion">{{$registro_ac_as_ordinarias->descripcion}}</textarea>
                            <p class="advertencia-error" id="error-descripcion"></p>
                        </div>

                        <div class="campo-form-control">
                            <label for="">Institucion<span class="asterisco-label">*</span></label>
                            <input type="text" name="institucion" value="{{$registro_ac_as_ordinarias->institucion}}"
                                maxlength="580">
                        ...
                        <div class="campo-form-control-area">
                            ...
                            <textarea name="observacion">{{$registro_ac_as_ordinarias->observacion}}</textarea>
                        ...
                        <div class="image-pre-view">
                            @if($registro_ac_as_ordinarias->archivo==null)
                            <img src="{{asset('assets/images/image-preview.png')}}" alt="Archivo Subido"
                                id="vista-previa">
                            @else
                            <img src="data:image/all;base64,{{base64_encode($registro_ac_as_ordinarias->archivo)}}"
    ...
    <script src="{{asset('assets/js/app/RegistroAcAsOrdinarias.js')}}?v={{config('constants.VERSION_JS')}}"></script>
