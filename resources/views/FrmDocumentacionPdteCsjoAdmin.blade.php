...
<body>
    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                ...
                <div class="title-info-color-1">Registrar | Inventario de Documentacion Pdte. Csjo. Administracion</div>
                    ...
                    <form class="mi-form-control" id="mi-form" enctype="multipart/form-data">
                        ...
                        <div class="form-control-colum-2">
                            ...
                            <div class="campo-form-control-2">
                                ...
                                <input type="text" name="detalle" value="{{$doc_pdte_csjo_admin->detalle}}">
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                <input type="number" name="cantidad" value="{{$doc_pdte_csjo_admin->cantidad}}" min="0">
                                <p class="advertencia-error" id="error-cantidad"></p>
                            </div>
                            <div class="campo-form-control-2">
                                <label for="">Rubro<span class="asterisco-label">*</span></label>
                                <input type="text" name="rubro" value="{{$doc_pdte_csjo_admin->rubro}}">
                        ...
                        <div class="campo-form-control-area">
                            ...
                            <textarea name="observacion">{{$doc_pdte_csjo_admin->observacion}}</textarea>
                        ...
                        <div class="image-pre-view">
                            @if($doc_pdte_csjo_admin->archivo==null)
                            <img src="{{asset('assets/images/image-preview.png')}}" alt="Archivo Subido"
                                id="vista-previa">
                            @else
                            <img src="data:image/all;base64,{{base64_encode($doc_pdte_csjo_admin->archivo)}}"
    ...
    <script src="{{asset('assets/js/app/DocumentacionPdteCsjoAdmin.js')}}?v={{config('constants.VERSION_JS')}}">
    </script>
