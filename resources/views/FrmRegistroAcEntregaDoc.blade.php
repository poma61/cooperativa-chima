...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/css/sideBar.css')}}?v={{config('constants.VERSION_CSS')}}"
        type="text/css" media="all">
    <link rel="stylesheet" href="{{asset('assets/css/style500.css')}}?v={{config('constants.VERSION_CSS')}}"
        type="text/css" media="all">
...
<body>
    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                ...
                <div class="title-info">Registrar Actas Entrega de Documentacion</div>

                <div class="container-menu-opciones-all">
                    <!-- menu opciones-->
                    <x-menu_opciones.MenuOpRegistroAcEntregaDoc />
                </div>


                <!-- formulario-->
                <div class="container-form">
                    <h3 class="title-form-control">Entrega de Documentacion</h3>
                    ...
                    <form class="mi-form-control" id="mi-form" enctype="multipart/form-data">
                        ...
                        <div class="campo-form-control">
                            ...
                            <input type="text" name="referencia" value="{{$registro_ac_entrega_doc->referencia}}"
                                maxlength="580">
                        ...
                        <div class="campo-form-control-area">
                            ...
                            <textarea name="descripcion">{{$registro_ac_entrega_doc->descripcion}}</textarea>
                            <p class="advertencia-error" id="error-descripcion"></p>
                        </div>

                        <div class="campo-form-control">
                            <label for="">Institucion/Responsable<span class="asterisco-label">*</span></label>
                            <input type="text" name="institucion_responsable"
                                value="{{$registro_ac_entrega_doc->institucion_responsable}}" maxlength="580">
                            <p class="advertencia-error" id="error-institucion_responsable"></p>
                        </div>

                        <div class="campo-form-control-area">
                            <label for="">Observacion<span class="asterisco-label">*</span></label>
                            <textarea name="observacion">{{$registro_ac_entrega_doc->observacion}}</textarea>
                        ...
                        <div class="image-pre-view">
                            @if($registro_ac_entrega_doc->archivo==null)
                            <img src="{{asset('assets/images/image-preview.png')}}" alt="Archivo Subido"
                                id="vista-previa">
                            @else
                            <img src="data:image/all;base64,{{base64_encode($registro_ac_entrega_doc->archivo)}}"
    ...
    <script src="{{asset('assets/js/app/RegistroAcEntregaDoc.js')}}?v={{config('constants.VERSION_JS')}}"></script>
