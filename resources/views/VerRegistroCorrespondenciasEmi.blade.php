                    ...
                    <section class="container-menu-opciones-vertical">
                        <ul class="list-menu-opciones">
                            ...
                            <li class="item-menu-opciones">
                                <a class="color-100"
                                    href="{{route('route-frm-show-registro-correspondencias-emi',MyEncryption::encrypt($registro_correspondencias_emi->id))}}">
                            ...
                            <li class="item-menu-opciones">
                                <a class="color-100" style="cursor:pointer;" id="btn-accion"
                                    ...
                                    data-id_reg="{{MyEncryption::encrypt($registro_correspondencias_emi->id)}}">
                                    <i class="zmdi zmdi-delete"></i><span> Eliminar</span></a>
                            </li>
                            <li class="item-menu-opciones">
                                <a class="color-100"
                                    href="{{route('route-ver-registro-correspondencias-emi',MyEncryption::encrypt($registro_correspondencias_emi->id))}}">
                                    <i class="zmdi zmdi-file-text"></i><span> Ver Registro</span></a>
                            </li>
                            <li class="item-menu-opciones">
                                <a class="color-100"
                                    href="{{route('route-pdf-ver-registro-correspondencias-emi',MyEncryption::encrypt($registro_correspondencias_emi->id))}}">
                                    <i class="zmdi zmdi-download"></i><span> PDF</span> </a>
                            </li>
                            <li class="item-menu-opciones">
                                <a class="color-100"
                                    href="{{route('route-imprimir-ver-registro-correspondencias-emi',MyEncryption::encrypt($registro_correspondencias_emi->id))}}">
