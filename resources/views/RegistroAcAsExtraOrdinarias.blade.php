...
<body>
    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                <div class="title-info">Registro de Actas Asambleas Extra Ordinarias</div>
                    ...
                    <div class="table-responsive">
                        <table id="tabla-datos" class="color-table-2">
                            ...
                            <tbody>
                                ...
                                $cantidad_filas=20;
                                @endphp
                                @foreach($registro_ac_as_extra_ordinarias as $row)
                                @if($cantidad_filas>0)
                                <tr>
                                    <td>{{$row->num_reg}}</td>
                                    ...
                                    <td>
                                        <a href="{{route('route-frm-show-registro-ac-as-extra-ordinarias',MyEncryption::encrypt($row->id))}}"
                                            class="edit-reg"><i class="zmdi zmdi-edit"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{route('route-pdf-id-registro-ac-as-extra-ordinarias',MyEncryption::encrypt($row->id))}}"
