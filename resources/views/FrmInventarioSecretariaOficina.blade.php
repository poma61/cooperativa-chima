...
<body>
    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                ...
                <div class="title-info-color-2">Registrar | Inventario Secretaria - Oficina</div>
                    ...
                    <form class="mi-form-control" id="mi-form" enctype="multipart/form-data">
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                @if($inventario_secretaria_of->id==0)
                                <input type="number" name="numero-de-registro" disabled
                                    value="{{str_pad($num_registro,5,'0',STR_PAD_LEFT)}}">
                                @else
                                <input type="number" name="numero-de-registro" disabled
                                    value="{{$inventario_secretaria_of->num_reg}}">
                                <input type="hidden" name="id-reg"
                                    value="{{MyEncryption::encrypt($inventario_secretaria_of->id)}}">
                                @endif
                            </div>
                            <div class="campo-form-control-2">
                                <label for="">Detalle<span class="asterisco-label">*</span></label>
                                <input type="text" name="detalle" value="{{$inventario_secretaria_of->detalle}}">
                        ...
                        <div class="form-control-colum-2">
                            <div class="campo-form-control-2">
                                ...
                                <input type="number" name="cantidad" value="{{$inventario_secretaria_of->cantidad}}"
                                    min="0">
                                <p class="advertencia-error" id="error-cantidad"></p>
                            </div>
                            <div class="campo-form-control-2">
                                <label for="">Estado<span class="asterisco-label">*</span></label>
                                <input type="text" name="estado" value="{{$inventario_secretaria_of->estado}}">
                        ...
                        <div class="campo-form-control-area">
                            ...
                            <textarea name="observacion">{{$inventario_secretaria_of->observacion}}</textarea>
                        ...
                        <div class="image-pre-view">
                            @if($inventario_secretaria_of->archivo==null)
                            <img src="{{asset('assets/images/image-preview.png')}}" alt="Archivo Subido"
                                id="vista-previa">
                            @else
                            <img src="data:image/all;base64,{{base64_encode($inventario_secretaria_of->archivo)}}"
    ...
    <script src="{{asset('assets/js/app/InventarioSecretariaOficina.js')}}?v={{config('constants.VERSION_JS')}}">
    </script>
