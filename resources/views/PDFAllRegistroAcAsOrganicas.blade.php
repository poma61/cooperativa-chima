...
<head>
    ...
    <link rel="stylesheet" href="{{public_path('assets/css/pdf-all-registro-ac-as-organicas.css')}}" type="text/css" media="all">
        ...
        <header class="encabezado">
            <table class="table-titles">
                <tr>
                    ...
                    <td>
                        <h2>Control de Actas Asambleas Organicas</h2><small>Por Secretaria General</small>
                    </td>
                </tr>
            </table>
        </header>
