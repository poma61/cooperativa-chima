...
<body>
    ...
    <div class="layout has-sidebar fixed-sidebar fixed-header">
        ...
        <div class="layout">
            ...
            <main class="content">
                <div class="title-info">Registro de Actas Reuniones</div>
                        ...
                        <table id="tabla-datos" class="color-table-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('route-frm-show-registro-ac-reuniones',MyEncryption::encrypt($row->id))}}"
                                            class="edit-reg"><i class="zmdi zmdi-edit"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{route('route-pdf-id-registro-ac-reuniones',MyEncryption::encrypt($row->id))}}"
