...
class ControllerRegistroAcReuniones extends Controller
{
    ...
    {
        try {
            $registro_ac_reuniones = RegistroAcReuniones::where('status', true)->find(MyEncryption::decrypt($id));
    ...
    public function update(Request $request)
    {
        ...
        try {
            $registro_ac_reuniones = RegistroAcReuniones::where('status', true)->find(MyEncryption::decrypt($request->input('id-reg')));
