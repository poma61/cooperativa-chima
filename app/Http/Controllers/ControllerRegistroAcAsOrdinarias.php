...
class ControllerRegistroAcAsOrdinarias extends Controller
{
    ...
    {
        try {
            $registro_ac_as_ordinarias = RegistroAcAsOrdinarias::where('status', true)->find(MyEncryption::decrypt($id));
    ...
    public function update(Request $request)
    {
        ...
        try {
            $registro_ac_as_ordinarias = RegistroAcAsOrdinarias::where('status', true)->find(MyEncryption::decrypt($request->input('id-reg')));
