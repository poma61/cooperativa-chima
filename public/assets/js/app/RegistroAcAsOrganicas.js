...
let uri = "";
let uri_store = "/api/store-registro-ac-as-organicas";
let uri_update = "/api/update-registro-ac-as-organicas";
let uri_destroy = "/api/destroy-registro-ac-as-organicas";
let uri_archivo = "/api/archivo-registro-ac-as-organicas";
let uri_imprimir = "/api/imprimir-id-registro-ac-as-organicas";
let uri_index = "/registro-ac-as-organicas";

let registro_ac_as_organicas = new RegistroAcAsOrganicas(container_popup, null, null, uri, uri_store, uri_update, uri_destroy, uri_archivo, uri_imprimir, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            registro_ac_as_organicas.setForm = form_data;
            registro_ac_as_organicas.store();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    registro_ac_as_organicas.setForm = form_data;
    registro_ac_as_organicas.setFilaTableDelete = fila;
    registro_ac_as_organicas.confirmDestroy();
...
onClick(document, 'click', '#file', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_as_organicas.setForm = form_data;
    registro_ac_as_organicas.archivoApi();
...
onClick(document, 'click', '#print', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_as_organicas.setForm = form_data;
    registro_ac_as_organicas.imprimirView();
});
