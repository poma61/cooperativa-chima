...
class RegistroMemorandums {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case 'referencia':
                ...
                break;
            case 'entregado_a':
                mensaje_error = document.getElementById('error-entregado_a');
                mensaje_error.innerText = mensaje;
                break;
            case 'cargo':
            ...
            case 'sancion_gr':
                mensaje_error = document.getElementById('error-sancion_gr');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('entregado_a');
        input_form[0].value = '';

        input_form = document.getElementsByName('cargo');
        input_form[0].value = '';

        input_form = document.getElementsByName('sancion_gr');
        input_form[0].value = '';
...
let uri = "";
let uri_store = "/api/store-registro-memorandums";
let uri_update = "/api/update-registro-memorandums";
let uri_destroy = "/api/destroy-registro-memorandums";
let uri_index = "/registro-memorandums";

let registro_memorandums = new RegistroMemorandums(container_popup, null, uri, uri_store, uri_update, uri_destroy, uri_index);
...
btn_enviar.addEventListener('click', () => {
    ...
    switch (accion) {
        case 'store':
            ...
            registro_memorandums.setForm = form_data;
            registro_memorandums.store();
            break;

        case 'confirm-destroy':
            registro_memorandums.confirmDestroy();
            break;
