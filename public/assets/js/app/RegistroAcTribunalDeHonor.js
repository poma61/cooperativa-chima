...
class RegistroAcTribunalDeHonor {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case 'descripcion':
                ...
                break;
            case 'institucion':
                mensaje_error = document.getElementById('error-institucion');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('institucion');
        input_form[0].value = '';
...
let uri = "";
let uri_store = "/api/store-registro-ac-tribunal-de-honor";
let uri_update = "/api/update-registro-ac-tribunal-de-honor";
let uri_destroy = "/api/destroy-registro-ac-tribunal-de-honor";
let uri_archivo = "/api/archivo-registro-ac-tribunal-de-honor";
let uri_imprimir = "/api/imprimir-id-registro-ac-tribunal-de-honor";
let uri_index = "/registro-ac-tribunal-de-honor";

let registro_ac_historial_de_honor = new RegistroAcTribunalDeHonor(container_popup, null, null, uri, uri_store, uri_update, uri_destroy, uri_archivo, uri_imprimir, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            registro_ac_historial_de_honor.setForm = form_data;
            registro_ac_historial_de_honor.store();
            break;

        case 'update':
            form_data = document.getElementById('mi-form');
            registro_ac_historial_de_honor.setForm = form_data;
            registro_ac_historial_de_honor.update();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    registro_ac_historial_de_honor.setForm = form_data;
    registro_ac_historial_de_honor.setFilaTableDelete = fila;
    registro_ac_historial_de_honor.confirmDestroy();
...
onClick(document, 'click', '#file', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_historial_de_honor.setForm = form_data;
    registro_ac_historial_de_honor.archivoApi();
...
onClick(document, 'click', '#print', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_historial_de_honor.setForm = form_data;
    registro_ac_historial_de_honor.imprimirView();
});
