...
class DocumentacionPdteCsjoAdmin {
...
let uri = "";
let uri_store = "/api/store-documentacion-pdte-csjo-admin";
let uri_update = "/api/update-documentacion-pdte-csjo-admin";
let uri_destroy = "/api/destroy-documentacion-pdte-csjo-admin";
let uri_archivo = "/api/archivo-documentacion-pdte-csjo-admin";
let uri_imprimir = "/api/imprimir-id-documentacion-pdte-csjo-admin";
let uri_index = "/documentacion-pdte-csjo-admin";

let doc_pdte_csjo_admin = new DocumentacionPdteCsjoAdmin(container_popup, null, null, uri, uri_store, uri_update, uri_destroy, uri_archivo, uri_imprimir, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            doc_pdte_csjo_admin.setForm = form_data;
            doc_pdte_csjo_admin.store();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    doc_pdte_csjo_admin.setForm = form_data;
    doc_pdte_csjo_admin.setFilaTableDelete = fila;
    doc_pdte_csjo_admin.confirmDestroy();
...
onClick(document, 'click', '#file', e => {
    ...
    form_data.append('id-reg', id);
    doc_pdte_csjo_admin.setForm = form_data;
    doc_pdte_csjo_admin.archivoApi();
...
onClick(document, 'click', '#print', e => {
    ...
    form_data.append('id-reg', id);
    doc_pdte_csjo_admin.setForm = form_data;
    doc_pdte_csjo_admin.imprimirView();
});
