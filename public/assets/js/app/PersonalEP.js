...
class PersonalEP {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case "sueldo_asignado":
                mensaje_error = document.getElementById('error-sueldo_asignado');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('sueldo_asignado');
        input_form[0].value = '';
...
let uri = "";
let uri_store = "/api/store-personal-planta";
let uri_update = "/api/update-personal-planta";
let uri_destroy = "/api/destroy-personal-planta";
let uri_index = "/personal-planta";


let socios = new PersonalEP(container_popup, null, uri, uri_store, uri_update, uri_destroy, uri_index);
