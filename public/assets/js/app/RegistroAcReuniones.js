...
let uri = "";
let uri_store = "/api/store-registro-ac-reuniones";
let uri_update = "/api/update-registro-ac-reuniones";
let uri_destroy = "/api/destroy-registro-ac-reuniones";
let uri_archivo = "/api/archivo-registro-ac-reuniones";
let uri_imprimir = "/api/imprimir-id-registro-ac-reuniones";
let uri_index = "/registro-ac-reuniones";

let registro_ac_reuniones = new RegistroAcReuniones(container_popup, null, null, uri, uri_store, uri_update, uri_destroy, uri_archivo, uri_imprimir, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            registro_ac_reuniones.setForm = form_data;
            registro_ac_reuniones.store();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    registro_ac_reuniones.setForm = form_data;
    registro_ac_reuniones.setFilaTableDelete = fila;
    registro_ac_reuniones.confirmDestroy();
...
onClick(document, 'click', '#file', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_reuniones.setForm = form_data;
    registro_ac_reuniones.archivoApi();
...
onClick(document, 'click', '#print', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_reuniones.setForm = form_data;
    registro_ac_reuniones.imprimirView();
});
