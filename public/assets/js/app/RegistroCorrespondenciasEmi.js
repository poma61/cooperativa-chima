...
class RegistroCorrespondenciasEmi {
...
let uri = "";
let uri_store = "/api/store-registro-correspondencias-emi";
let uri_update = "/api/update-registro-correspondencias-emi";
let uri_destroy = "/api/destroy-registro-correspondencias-emi";
let uri_index = "/registro-correspondencias-emi";

let historial_personal_ep = new RegistroCorrespondenciasEmi(container_popup, null, uri, uri_store, uri_update, uri_destroy, uri_index);
