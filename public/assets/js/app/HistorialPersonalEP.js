...
class HistorialPersonalEP {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case 'mes':
                mensaje_error = document.getElementById('error-mes');
                mensaje_error.innerText = mensaje;
                break;
            case 'dias':
                mensaje_error = document.getElementById('error-dias');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('mes');
        input_form[0].value = '';

        input_form = document.getElementsByName('dias');
        input_form[0].value = '';
    ...
    destroy() {
        ...
        fetch(this.url + this.destroy_url, {
            ...
            if (result.errors_db == true) {
                ...
                let id = document.getElementById('btn-accion').dataset.id_personal_ep;
...
let uri = "";
let uri_store = "/api/store-historial-personal-planta";
let uri_update = "/api/update-historial-personal-planta";
let uri_destroy = "/api/destroy-historial-personal-planta";
let uri_index = "/historial-personal-planta";


let historial_personal_ep = new HistorialPersonalEP(container_popup, null, uri, uri_store, uri_update, uri_destroy, uri_index);
