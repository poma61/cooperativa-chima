    ...
    destroy() {
        ...
        fetch(this.url + this.destroy_url, {
            ...
            if (result.errors_db == true) {
                ...
                let id = document.getElementById('btn-accion').dataset.id_personal_em;
...
let uri = "";
let uri_store = "/api/store-historial-personal-mita";
let uri_update = "/api/update-historial-personal-mita";
let uri_destroy = "/api/destroy-historial-personal-mita";
let uri_index = "/historial-personal-mita";
