...
class SalidaAlmacen {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case 'codigo':
                ...
                mensaje_error.innerText = mensaje;
                break;
            case 'nombre_del_articulo':
                mensaje_error = document.getElementById('error-nombre_del_articulo');
                mensaje_error.innerText = mensaje;
                break;
            ...
            case 'destino_sector':
                mensaje_error = document.getElementById('error-destino_sector');
                mensaje_error.innerText = mensaje;
                break;
            ...
            case 'autorizado_por':
                mensaje_error = document.getElementById('error-autorizado_por');
                mensaje_error.innerText = mensaje;
                break;

            case 'interesado':
                mensaje_error = document.getElementById('error-interesado');
                mensaje_error.innerText = mensaje;
                break;

            case 'firma':
                mensaje_error = document.getElementById('error-firma');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('nombre_del_articulo');
        input_form[0].value = '';

        input_form = document.getElementsByName('referencia');
        input_form[0].value = "";

        input_form = document.getElementsByName('destino_sector');
        input_form[0].value = '';

        input_form = document.getElementsByName('entregado_por');
        input_form[0].value = "";

        input_form = document.getElementsByName('autorizado_por');
        input_form[0].value = '';

        input_form = document.getElementsByName('interesado');
        input_form[0].value = '';

        input_form = document.getElementsByName('firma');
        input_form[0].value = '';
...
let uri = "";
let uri_store = "/api/store-salida-almacen";
let uri_update = "/api/update-salida-almacen";
let uri_destroy = "/api/destroy-salida-almacen";
let uri_index = "/salida-almacen";

let salida_almacen = new SalidaAlmacen(container_popup, null,null, uri, uri_store, uri_update, uri_destroy, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            salida_almacen.setForm = form_data;
            salida_almacen.store();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    salida_almacen.setForm = form_data;
    salida_almacen.setFilaTableDelete = fila;
    salida_almacen.confirmDestroy();
