...
class InventarioDocStrioGeneral {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case 'cantidad':
                ...
                break;
            case 'rubro':
                mensaje_error = document.getElementById('error-rubro');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('rubro');
        input_form[0].value = '';
    ...
    imprimirView() {
        fetch(this.url + this.imprimir_url, {
            ...
            if (result instanceof Blob) {
                ...
                this.viewPopupMessage('error', 'Error', 'Ocurrio un error al obtener la vista previa de la impresión!');
...
let uri = "";
let uri_store = "/api/store-inventario-doc-strio-general";
let uri_update = "/api/update-inventario-doc-strio-general";
let uri_destroy = "/api/destroy-inventario-doc-strio-general";
let uri_archivo = "/api/archivo-inventario-doc-strio-general";
let uri_imprimir = "/api/imprimir-id-inventario-doc-strio-general";
let uri_index = "/inventario-doc-strio-general";

let inventario_doc_strio_general = new InventarioDocStrioGeneral(container_popup, null, null, uri, uri_store, uri_update, uri_destroy, uri_archivo, uri_imprimir, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            inventario_doc_strio_general.setForm = form_data;
            inventario_doc_strio_general.store();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    inventario_doc_strio_general.setForm = form_data;
    inventario_doc_strio_general.setFilaTableDelete = fila;
    inventario_doc_strio_general.confirmDestroy();
...
onClick(document, 'click', '#file', e => {
    ...
    form_data.append('id-reg', id);
    inventario_doc_strio_general.setForm = form_data;
    inventario_doc_strio_general.archivoApi();
...
onClick(document, 'click', '#print', e => {
    ...
    form_data.append('id-reg', id);
    inventario_doc_strio_general.setForm = form_data;
    inventario_doc_strio_general.imprimirView();
});
