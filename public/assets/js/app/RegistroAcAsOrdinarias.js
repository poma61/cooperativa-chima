...
let uri = "";
let uri_store = "/api/store-registro-ac-as-ordinarias";
let uri_update = "/api/update-registro-ac-as-ordinarias";
let uri_destroy = "/api/destroy-registro-ac-as-ordinarias";
let uri_archivo = "/api/archivo-registro-ac-as-ordinarias";
let uri_imprimir = "/api/imprimir-id-registro-ac-as-ordinarias";
let uri_index = "/registro-ac-as-ordinarias";

let registro_ac_as_ordinarias = new RegistroAcAsOrdinarias(container_popup, null, null, uri, uri_store, uri_update, uri_destroy, uri_archivo, uri_imprimir, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            registro_ac_as_ordinarias.setForm = form_data;
            registro_ac_as_ordinarias.store();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    registro_ac_as_ordinarias.setForm = form_data;
    registro_ac_as_ordinarias.setFilaTableDelete = fila;
    registro_ac_as_ordinarias.confirmDestroy();
...
onClick(document, 'click', '#file', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_as_ordinarias.setForm = form_data;
    registro_ac_as_ordinarias.archivoApi();
...
onClick(document, 'click', '#print', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_as_ordinarias.setForm = form_data;
    registro_ac_as_ordinarias.imprimirView();
});
