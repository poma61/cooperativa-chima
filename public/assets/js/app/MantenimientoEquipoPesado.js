...
class MantenimientoEquipoPesado {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case 'caracteristicas':
                mensaje_error = document.getElementById('error-caracteristicas');
                mensaje_error.innerText = mensaje;
                break;

            case 'desarrollo':
                mensaje_error = document.getElementById('error-desarrollo');
                mensaje_error.innerText = mensaje;
                break;

            case 'material_ocupado':
                mensaje_error = document.getElementById('error-material_ocupado');
                mensaje_error.innerText = mensaje;
                break;


            case 'mantenimiento_preventivo':
                mensaje_error = document.getElementById('error-mantenimiento_preventivo');
                mensaje_error.innerText = mensaje;
                break;

            case 'mantenimiento_correctivo':
                mensaje_error = document.getElementById('error-mantenimiento_correctivo');
                mensaje_error.innerText = mensaje;
                break;

            case 'fecha_de_salida':
                mensaje_error = document.getElementById('error-fecha_de_salida');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('caracteristicas');
        input_form[0].value = '';

        input_form = document.getElementsByName('desarrollo');
        input_form[0].value = '';

        input_form = document.getElementsByName('material_ocupado');
        input_form[0].value = '';

        input_form = document.getElementsByName('mantenimiento_preventivo');
        input_form[0].value = '';

        input_form = document.getElementsByName('mantenimiento_correctivo');
        input_form[0].value = '';

        input_form = document.getElementsByName('fecha_de_salida');
        input_form[0].value = this.formatFechaHTML();
    ...
    destroy() {
        ...
        fetch(this.url + this.destroy_url, {
            ...
            if (result.errors_db == true) {
                ...
                let id = document.getElementById('btn-accion').dataset.id_equipo_pesado;
                window.location.replace('http://' + base_url + this.index_url + '/' + id);
            }
...
let uri = "";
let uri_store = "/api/store-mantenimiento-equipo-pesado";
let uri_update = "/api/update-mantenimiento-equipo-pesado";
let uri_destroy = "/api/destroy-mantenimiento-equipo-pesado";
let uri_index = "/mantenimiento-equipo-pesado";


let historial_personal_ep = new MantenimientoEquipoPesado(container_popup, null, uri, uri_store, uri_update, uri_destroy, uri_index);
