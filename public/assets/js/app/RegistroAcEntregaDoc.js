...
class RegistroAcEntregaDoc {
    ...
    viewMensajeErrorCampos(campo_error, mensaje) {
        ...
        switch (campo_error) {
            ...
            case 'descripcion':
                ...
                mensaje_error.innerText = mensaje;
                break;
            case 'institucion_responsable':
                mensaje_error = document.getElementById('error-institucion_responsable');
                mensaje_error.innerText = mensaje;
                break;
    ...
    clearInputsForm() {
        ...
        input_form = document.getElementsByName('institucion_responsable');
        input_form[0].value = '';
...
let uri = "";
let uri_store = "/api/store-registro-ac-entrega-doc";
let uri_update = "/api/update-registro-ac-entrega-doc";
let uri_destroy = "/api/destroy-registro-ac-entrega-doc";
let uri_archivo = "/api/archivo-registro-ac-entrega-doc";
let uri_imprimir = "/api/imprimir-id-registro-ac-entrega-doc";
let uri_index = "/registro-ac-entrega-doc";

let registro_ac_entrega_doc = new RegistroAcEntregaDoc(container_popup, null, null, uri, uri_store, uri_update, uri_destroy, uri_archivo, uri_imprimir, uri_index);
...
onClick(document, 'click', '#btn-accion', e => {
    ...
    switch (accion) {
        case 'store':
            ...
            registro_ac_entrega_doc.setForm = form_data;
            registro_ac_entrega_doc.store();
            break;
...
onClick(document, 'click', '#delete', e => {
    ...
    registro_ac_entrega_doc.setForm = form_data;
    registro_ac_entrega_doc.setFilaTableDelete = fila;
    registro_ac_entrega_doc.confirmDestroy();
...
onClick(document, 'click', '#file', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_entrega_doc.setForm = form_data;
    registro_ac_entrega_doc.archivoApi();
...
onClick(document, 'click', '#print', e => {
    ...
    form_data.append('id-reg', id);
    registro_ac_entrega_doc.setForm = form_data;
    registro_ac_entrega_doc.imprimirView();
});
